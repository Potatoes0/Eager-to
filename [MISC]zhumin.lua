...
local menu = {
    ...
    text = ui_new_textbox("MISC", "Miscellaneous", "Text"),
    animated = ui_new_checkbox("MISC", "Miscellaneous", "Animated tag"),
    style = ui_new_combobox("MISC", "Miscellaneous", "Animation style", "Default", "Reverse", "Loop", "Classic"),
...
local function handleMenu()
	...
	local bState = ui_get(menu.enabled)
	local bAnimationState = ui_get(menu.animated) and bState
	...
	ui_set_visible(menu.clantags, bState)
    ui_set_visible(menu.animated, bState)
	ui_set_visible(menu.text, bState)
	ui_set_visible(menu.style, bAnimationState)
    ui_set_visible(menu.speed, bAnimationState)
